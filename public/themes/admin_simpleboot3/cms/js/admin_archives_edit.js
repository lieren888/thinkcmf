...
function init(channel_id) {
    ...
    $.ajax({
        ...
        data: { "channel_id": channel_id, "archives_id": postId },
                    ...
                    for (i = 0; i < array.length; i++) {
                        ...
                        switch (item.type.toLowerCase()) {
                            case "string"://文本
                                ...
                                html += '    <td>';
                                html += '        <input class="form-control" type="text" name="post[' + item.name + ']" id="' + item.name + '" value="' + item.value + '" placeholder="请输入' + item.title + '"/>';
                                html += '    </td>';
                                html += '</tr>';
                                break;
                            case "text"://文本框
                                ...
                                html += '    <th>' + item.title + '</th>';
                                html += '    <td>';
                                html += '        <textarea class="form-control" name="post[' + item.name + ']" id="' + item.name + '" style="height: 50px;" placeholder="请填写' + item.title + '">' + item.value + '</textarea>';
                                html += '    </td>';
                                html += '</tr>';
                                break;
                            case "number"://数量
                            ...
                            case "date"://日期
                                ...
                                html += '    <th>' + item.title + '</th>';
                                html += '    <td>';
                                html += '        <input class="form-control js-bootstrap-' + item.name + '" type="text" name="post[' + item.name + ']" value="' + item.value + '" />';
                                html += '<script>';
                                html += '   $(function () {';
